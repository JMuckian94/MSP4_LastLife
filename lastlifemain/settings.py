"""
Django settings for lastlifemain project.
...
SECRET_KEY = '1CWp/mxj8~rnV]$/"5JM/.j|.C">Hh'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(lastlifemain_DIR, 'templates'),
            os.path.join(lastlifemain_DIR, 'templates', 'allauth'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = (os.path.join(lastlifemain_DIR, 'static'),)

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(lastlifemain_DIR, 'media')
