...
def all_products(request):
    ...
    if request.GET:
        ...
        if 'q' in request.GET:
            query = request.GET['q']
            if not query:
                messages.error(request, "You didn't enter any search criteria. Please try again.")
...
def edit_product(request, product_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'Failed to update product details. Please check your form and try again.')
    else:
